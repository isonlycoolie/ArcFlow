...
Run the HTTP server with secrets in the environment, not in the image. Contract: [server-api-v1.md](../../normative/runtime/server-api-v1.md).
...
## Meta-repo (dashboard + OSS)

Private product layout: [meta-repo.md](meta-repo.md).
